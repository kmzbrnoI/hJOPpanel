...
uses
  ...
  BlockLinkerTrain in 'blocks\BlockLinkerTrain.pas',
  ...
  BlocksTrack in 'blocks\BlocksTrack.pas',
  BlocksTurnout in 'blocks\BlocksTurnout.pas',
  BlockDerail in 'blocks\BlockDerail.pas',
